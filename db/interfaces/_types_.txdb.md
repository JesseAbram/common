...
*Defined in [types.ts:38](https://github.com/polkadot-js/common/blob/a358c8b/packages/db/src/types.ts#L38)*
...
*Defined in [types.ts:37](https://github.com/polkadot-js/common/blob/a358c8b/packages/db/src/types.ts#L37)*
