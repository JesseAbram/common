...
*Defined in [Impl.ts:38](https://github.com/polkadot-js/common/blob/1cd491b/packages/trie-db/src/Impl.ts#L38)*
...
*Defined in [Impl.ts:36](https://github.com/polkadot-js/common/blob/1cd491b/packages/trie-db/src/Impl.ts#L36)*
