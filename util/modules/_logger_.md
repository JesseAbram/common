...
*Defined in [logger.ts:42](https://github.com/polkadot-js/common/blob/6df8d6b/packages/util/src/logger.ts#L42)*
...
*Defined in [logger.ts:104](https://github.com/polkadot-js/common/blob/6df8d6b/packages/util/src/logger.ts#L104)*
